...
#define GPS_POWER_IF "/sys/bus/platform/devices/gps/power_on"
...
static void gps_state_init( GpsState*  state )
{
    ...
    strcpy(gps_data,"/dev/ttyUSB0") ; //RvdB
    /* RvdB
    ...
    strcpy(gps_ctrl,"/dev/ttyUSB0")  ;//RvdB
	...
	D("gps will be controlled on %s", gps_ctrl);
